...
BOOL VERSION_CALL_CONVENTION GetFileVersionInfoExA_( DWORD dwFlags, LPCSTR lpwstrFilename, DWORD dwHandle, DWORD dwLen, LPVOID lpData ) {
    return reinterpret_cast< BOOL( VERSION_CALL_CONVENTION * )( DWORD, LPCSTR, DWORD, DWORD, LPVOID ) >( m_fGetFileVersionInfoExA )( dwFlags, lpwstrFilename, dwHandle, dwLen,
                                                                                                                                     lpData );
}
...
BOOL VERSION_CALL_CONVENTION GetFileVersionInfoExW_( DWORD dwFlags, LPCWSTR lpwstrFilename, DWORD dwHandle, DWORD dwLen, LPVOID lpData ) {
    return reinterpret_cast< BOOL( VERSION_CALL_CONVENTION * )( DWORD, LPCWSTR, DWORD, DWORD, LPVOID ) >( m_fGetFileVersionInfoExW )( dwFlags, lpwstrFilename, dwHandle, dwLen,
                                                                                                                                      lpData );
}
...
DWORD VERSION_CALL_CONVENTION VerFindFileA_( DWORD uFlags, LPCSTR szFileName, LPCSTR szWinDir, LPCSTR szAppDir, LPSTR szCurDir, PUINT puCurDirLen, LPSTR szDestDir,
                                             PUINT puDestDirLen ) {
    return reinterpret_cast< DWORD( VERSION_CALL_CONVENTION * )( DWORD, LPCSTR, LPCSTR, LPCSTR, LPSTR, PUINT, LPSTR, PUINT ) >( m_fVerFindFileA )(
        uFlags, szFileName, szWinDir, szAppDir, szCurDir, puCurDirLen, szDestDir, puDestDirLen );
}

FARPROC m_fVerFindFileW = 0;

DWORD VERSION_CALL_CONVENTION VerFindFileW_( DWORD uFlags, LPCWSTR szFileName, LPCWSTR szWinDir, LPCWSTR szAppDir, LPWSTR szCurDir, PUINT puCurDirLen, LPWSTR szDestDir,
                                             PUINT puDestDirLen ) {
    return reinterpret_cast< DWORD( VERSION_CALL_CONVENTION * )( DWORD, LPCWSTR, LPCWSTR, LPCWSTR, LPWSTR, PUINT, LPWSTR, PUINT ) >( m_fVerFindFileW )(
        uFlags, szFileName, szWinDir, szAppDir, szCurDir, puCurDirLen, szDestDir, puDestDirLen );
}

FARPROC m_fVerInstallFileA = 0;

DWORD VERSION_CALL_CONVENTION VerInstallFileA_( DWORD uFlags, LPCSTR szSrcFileName, LPCSTR szDestFileName, LPCSTR szSrcDir, LPCSTR szDestDir, LPCSTR szCurDir, LPSTR szTmpFile,
                                                PUINT puTmpFileLen ) {
    return reinterpret_cast< DWORD( VERSION_CALL_CONVENTION * )( DWORD, LPCSTR, LPCSTR, LPCSTR, LPCSTR, LPCSTR, LPSTR, PUINT ) >( m_fVerInstallFileA )(
        uFlags, szSrcFileName, szDestFileName, szSrcDir, szDestDir, szCurDir, szTmpFile, puTmpFileLen );
}

FARPROC m_fVerInstallFileW = 0;

DWORD VERSION_CALL_CONVENTION VerInstallFileW_( DWORD uFlags, LPCWSTR szSrcFileName, LPCWSTR szDestFileName, LPCWSTR szSrcDir, LPCWSTR szDestDir, LPCWSTR szCurDir,
                                                LPWSTR szTmpFile, PUINT puTmpFileLen ) {
    return reinterpret_cast< DWORD( VERSION_CALL_CONVENTION * )( DWORD, LPCWSTR, LPCWSTR, LPCWSTR, LPCWSTR, LPCWSTR, LPWSTR, PUINT ) >( m_fVerInstallFileW )(
        uFlags, szSrcFileName, szDestFileName, szSrcDir, szDestDir, szCurDir, szTmpFile, puTmpFileLen );
}
